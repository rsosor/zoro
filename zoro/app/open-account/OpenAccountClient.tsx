...
export default function App() {
  ...
  const tutorialImages = [
    ...
    { id: 19, src: "/zoro/imgs/teaching/open_account/19.png", alt: "預覽畫面" },
    { id: 20, src: "/zoro/imgs/teaching/open_account/20.png", alt: "預覽畫面" },
    {
      id: 21,
      src: "/zoro/imgs/teaching/open_account/21.png",
      alt: "預覽畫面(契約副本下載)",
    },
    {
      id: 22,
    ...
    { id: 23, src: "/zoro/imgs/teaching/open_account/23.png", alt: "契約副本" },
    {
      id: 24,
      src: "/zoro/imgs/teaching/open_account/24.png",
      alt: "開戶完成！",
    },
  ];
